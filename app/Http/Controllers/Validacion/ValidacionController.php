<?php namespace GestorInventarios\Http\Controllers\Validacion;

use GestorInventarios\Http\Controllers\Controller;
use Illuminate\Foundation\Auth\AuthenticatesAndRegistersUsers;
use Illuminate\Http\Request;

use GestorInventarios\Http\Requests\IniciarSesionRequest;
use GestorInventarios\Http\Requests\RecuperarContrasenaRequest;

use GestorInventarios\Usuario;
...
class ValidacionController extends Controller 
{
	...
	public function postRecuperar(ppRecuperarContrasenaRequest $request)
	{
