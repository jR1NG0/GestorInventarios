            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                            <label for="departmento_id" class="col-md-4 control-label">Seleccione Area</label>
                            <div class="col-md-6">
                                <select class="form-control" name="departmento_id" >
                                   @foreach ($departamentos as $departamento)
                                         <option value="{{ $departamento->departmento_id }}">{{ $departamento->nombre }}</option> 
                                    @endforeach
                                </select>
                            </div>
                        </div>
